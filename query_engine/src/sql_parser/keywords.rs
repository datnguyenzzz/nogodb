...
define_keywords!(
    ...
    GROUPING, HASH, HASHES, HAVING, ID, IF, IN, INNER, INSERT, INT, INTERSECT, INTERVAL, JOIN,
    LEFT, LIKE, LIMIT, MOD, NOT, NULL, OFFSET, OR, OUTER, PRECISION, QUERY, REGEXP, SELECT, TABLE,
    TRUE, TRY_CAST, UNSIGNED, UPDATE, VARCHAR, WHERE, XOR
);
