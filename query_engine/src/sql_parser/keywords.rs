...
define_keywords!(
    ALTER, ANALYZE, AND, AS, ASC, BETWEEN, BIGINT, BOOLEAN, BY, CAST, CEIL, COALESCE, COLLATE,
    COUNT, CREATE, DATE, DELETE, DESC, DOUBLE, DROP, ELSE, ELSEIF, EMPTY, FALSE, FLOAT, FLOOR,
    FROM, FULL, GROUP, GROUPING, HASH, HASHES, HAVING, ID, IF, IN, INNER, INSERT, INT, INTERSECT,
    INTERVAL, INTO, JOIN, LEFT, LIKE, LIMIT, MOD, NOT, NULL, OFFSET, ON, OR, ORDER, OUTER,
    PRECISION, QUERY, REGEXP, RIGHT, SELECT, SET, TABLE, TRUE, TRY_CAST, UNSIGNED, UPDATE, VALUES,
    VARCHAR, WHERE, WITH, XOR
);
