...
define_keywords!(
    ALTER, ANALYZE, AND, AS, ASC, BETWEEN, BIGINT, BOOLEAN, CAST, CEIL, COALESCE, COLLATE, COUNT,
    CREATE, DATE, DELETE, DOUBLE, DROP, ELSE, ELSEIF, EMPTY, FALSE, FLOAT, FLOOR, FROM, GROUP,
    GROUPING, HASH, HASHES, HAVING, ID, IF, IN, INNER, INSERT, INT, INTERSECT, INTERVAL, INTO,
    JOIN, LEFT, LIKE, LIMIT, MOD, NOT, NULL, OFFSET, OR, OUTER, PRECISION, QUERY, REGEXP, SELECT,
    SET, TABLE, TRUE, TRY_CAST, UNSIGNED, UPDATE, VALUES, VARCHAR, WHERE, WITH, XOR
);
