...
define_keywords!(
    ...
    COUNT, CREATE, DATE, DELETE, DOUBLE, DROP, ELSE, ELSEIF, EMPTY, FALSE, FLOAT, FLOOR, FROM,
    FULL, GROUP, GROUPING, HASH, HASHES, HAVING, ID, IF, IN, INNER, INSERT, INT, INTERSECT,
    INTERVAL, INTO, JOIN, LEFT, LIKE, LIMIT, MOD, NOT, NULL, OFFSET, ON, OR, OUTER, PRECISION,
    QUERY, REGEXP, RIGHT, SELECT, SET, TABLE, TRUE, TRY_CAST, UNSIGNED, UPDATE, VALUES, VARCHAR,
    WHERE, WITH, XOR
);
