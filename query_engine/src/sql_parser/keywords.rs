...
define_keywords!(
    ...
    CREATE, DATE, DELETE, DOUBLE, DROP, ELSE, ELSEIF, EMPTY, FLOAT, FLOOR, FROM, GROUP, GROUPING,
    HASH, HASHES, HAVING, ID, IF, IN, INNER, INSERT, INT, INTERSECT, INTERVAL, JOIN, LEFT, LIKE,
    LIMIT, MOD, NOT, NOTNULL, OFFSET, OR, OUTER, PRECISION, QUERY, REGEXP, SELECT, TABLE, TRY_CAST,
    UNSIGNED, UPDATE, VARCHAR, WHERE, XOR
);
